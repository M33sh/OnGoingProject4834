<%@ Page Title="You are Logged In" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DefaultLoggedInc.aspx.cs" Inherits="WebForms._DefaultLoggedInc" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <ol class="round">
        ...
        <asp:Button ID="complete" runat="server" />
    </ol>
</asp:Content>
